        ...
        >
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            <div className="order-2 md:order-1 text-center md:text-left space-y-5 md:space-y-6">
              ...
              >
                <p className="text-base md:text-base lg:text-lg font-medium text-primary-600 dark:text-primary-400 mb-2">
                  {greeting}
                </p>
                <h1 className="font-bold mb-3 leading-tight text-3xl md:text-4xl lg:text-5xl xl:text-6xl break-words">
                  <span className="text-gradient glow-text">{name}</span>
                </h1>
                <h2 className="text-xl md:text-2xl lg:text-3xl xl:text-4xl font-bold text-gray-800 dark:text-gray-100 mb-3">
                  {title}
                </h2>
                <p className="text-base md:text-lg lg:text-xl font-medium text-gray-600 dark:text-gray-400">
                  {subtitle}
                </p>
              </motion.div>
              ...
              <motion.p
                ...
                className="text-base md:text-base lg:text-lg text-gray-600 dark:text-gray-400 leading-relaxed"
              >
                {description}
              </motion.p>
