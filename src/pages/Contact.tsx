            ...
            <div className="mt-auto pt-8 border-t border-gray-200 dark:border-gray-700">
              <h3 className="text-xl font-bold mb-6 text-gradient">{socialProfiles}</h3>
                <div className="flex flex-wrap gap-4">
                  <a href="https://linkedin.com/in/abderrahmane-kassimi" target="_blank" rel="noopener noreferrer" className="bg-gradient-primary/10 dark:bg-primary-500/20 p-4 rounded-xl text-primary-600 dark:text-primary-400 hover:bg-gradient-primary hover:text-white dark:hover:bg-primary-500 transition-all hover:scale-110 hover:shadow-lg">
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                      <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/>
                    </svg>
                  </a>
                  <a href="https://github.com/TNT-747" target="_blank" rel="noopener noreferrer" className="bg-gradient-primary/10 dark:bg-primary-500/20 p-4 rounded-xl text-primary-600 dark:text-primary-400 hover:bg-gradient-primary hover:text-white dark:hover:bg-primary-500 transition-all hover:scale-110 hover:shadow-lg">
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <a href="https://x.com/K81405442?t=CdN5sYl5PG_w38nGtRcm8g&s=09" target="_blank" rel="noopener noreferrer" className="bg-gradient-primary/10 dark:bg-primary-500/20 p-4 rounded-xl text-primary-600 dark:text-primary-400 hover:bg-gradient-primary hover:text-white dark:hover:bg-primary-500 transition-all hover:scale-110 hover:shadow-lg">
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                      <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                    </svg>
                  </a>
                  <a href="https://www.facebook.com/MESSI.KASSI?mibextid=ZbWKwL" target="_blank" rel="noopener noreferrer" className="bg-gradient-primary/10 dark:bg-primary-500/20 p-4 rounded-xl text-primary-600 dark:text-primary-400 hover:bg-gradient-primary hover:text-white dark:hover:bg-primary-500 transition-all hover:scale-110 hover:shadow-lg">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                      <path d="M9.198 21.5h4v-8.01h3.604l.396-3.98h-4V7.5a1 1 0 0 1 1-1h3v-4h-3a5 5 0 0 0-5 5v2.01h-2l-.396 3.98h2.396v8.01Z" />
                    </svg>
                  </a>
                  <a href="https://instagram.com/therealkassimi?igshid=MzMyNGUyNmU2YQ==" target="_blank" rel="noopener noreferrer" className="bg-gradient-primary/10 dark:bg-primary-500/20 p-4 rounded-xl text-primary-600 dark:text-primary-400 hover:bg-gradient-primary hover:text-white dark:hover:bg-primary-500 transition-all hover:scale-110 hover:shadow-lg">
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                      <path d="M12 2c2.717 0 3.056.01 4.122.06 1.065.05 1.79.217 2.428.465.66.254 1.216.598 1.772 1.153.509.5.902 1.105 1.153 1.772.247.637.415 1.363.465 2.428.047 1.066.06 1.405.06 4.122 0 2.717-.01 3.056-.06 4.122-.05 1.065-.218 1.79-.465 2.428a4.883 4.883 0 01-1.153 1.772c-.5.508-1.105.902-1.772 1.153-.637.247-1.363.415-2.428.465-1.066.047-1.405.06-4.122.06-2.717 0-3.056-.01-4.122-.06-1.065-.05-1.79-.218-2.428-.465a4.89 4.89 0 01-1.772-1.153 4.904 4.904 0 01-1.153-1.772c-.247-.637-.415-1.363-.465-2.428C2.013 15.056 2 14.717 2 12c0-2.717.01-3.056.06-4.122.05-1.066.217-1.79.465-2.428.254-.66.598-1.216 1.153-1.772.5-.509 1.105-.902 1.772-1.153.637-.247 1.362-.415 2.428-.465C8.944 2.013 9.283 2 12 2zm0 1.802c-2.67 0-2.987.01-4.04.059-.976.045-1.505.207-1.858.344-.466.182-.8.398-1.15.748-.35.35-.566.683-.748 1.15-.137.353-.3.882-.344 1.857-.048 1.053-.059 1.37-.059 4.04 0 2.67.01 2.987.059 4.04.045.976.207 1.504.344 1.857.182.466.399.8.748 1.15.35.35.683.566 1.15.748.353.137.882.3 1.857.344 1.054.048 1.37.059 4.04.059 2.67 0 2.987-.01 4.04-.059.976-.045 1.504-.207 1.857-.344.466-.182.8-.398 1.15-.748.35-.35.566-.683.748-1.15.137-.353.3-.882.344-1.857.048-1.054.059-1.37.059-4.04 0-2.67-.01-2.987-.059-4.04-.045-.976-.207-1.505-.344-1.858-.182-.466-.399-.8-.748-1.15-.35-.35-.683-.566-1.15-.748-.353-.137-.882-.3-1.857-.344-1.054-.048-1.37-.059-4.04-.059zm0 3.064a5.135 5.135 0 110 10.27 5.135 5.135 0 010-10.27zm0 8.468a3.333 3.333 0 100-6.666 3.333 3.333 0 000 6.666zm6.538-8.469a1.2 1.2 0 11-2.4 0 1.2 1.2 0 012.4 0z"/>
                    </svg>
                  </a>
                </div>
            </div>
